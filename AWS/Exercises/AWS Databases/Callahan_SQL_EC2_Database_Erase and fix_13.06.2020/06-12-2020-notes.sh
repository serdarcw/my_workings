...
mysql -h [you instance\'s DNS name] -u hr_guy -p clarusway 
...
sudo wget https://dev.mysql.com/getmysql57-community-release-el7-11.noarch.rpm
...
# select the database clarusway
USE clarusway;
# create a table nuseamed "offices" 
CREATE TABLE `offices` (
  `office_id` int(11) NOT NULL,
  `address` varchar(50) NOT NULL,
  `city` varchar(50) NOT NULL,
